### From https://levelup.gitconnected.com/how-to-use-llama3-3-to-build-a-local-agent-workflow-bf8be5be789c

! pip install crewai crewai-tools ollama twikit 
...
AUTH_INFO_1=Your X username
AUTH_INFO_2=Your X email
